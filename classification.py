...
gamma_list = [0.01, 0.05, 0.005, 0.001, 0.0005, 0.0001]
c_list = [0.1, 0.2, 0.5, 0.7, 0.8, 1, 2, 5, 7, 10]
...
print(h_params)
head = ['Dev acc','tst acc','tr acc']
print(tabulate([dv_acc, tst_acc, tr_acc], headers=head, tablefmt="grid"))